...
{
    public static class OutboxExtensionUseEntityFrameworkCore
    {
        public static void UseEntityFrameworkCore<TDbContext>(this IOutboxStorageConfigurator outboxStorageConfigurator)
