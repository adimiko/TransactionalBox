...
using TransactionalBox.EntityFrameworkCore.Tests.Internals.InternalPackages.DistributedLock.SeedWork;
...
namespace TransactionalBox.EntityFrameworkCore.Tests.Internals.InternalPackages.DistributedLock
{
